...
class LineProfile:
  def __init__(self, parent):
    parent.title = "LineProfile" # TODO make this more human readable by adding spaces
    parent.categories = ["Informatics"]
    parent.dependencies = []
    parent.contributors = ["Andras Lasso (PerkLab)"] # replace with "Firstname Lastname (Org)"
    parent.helpText = """
