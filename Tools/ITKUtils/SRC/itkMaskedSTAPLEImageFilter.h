 ...
 *
 *=========================================================================*/
#ifndef __itkMaskedSTAPLEImageFilter_h
#define __itkMaskedSTAPLEImageFilter_h
...
public:
    ...
    itkTypeMacro(MaskedSTAPLEImageFilter, ImageToImageFilter);
...
protected:
    ...
    virtual ~MaskedSTAPLEImageFilter() {}
    void GenerateData();

    void PrintSelf(std::ostream &, Indent) const;

private:
    MaskedSTAPLEImageFilter(const Self &); //purposely not implemented
...
#include "itkMaskedSTAPLEImageFilter.hxx"
#endif
