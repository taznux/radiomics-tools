...
GetMaskImage(LabelImageType::Pointer labelImage)
{
...
MaskImageType::Pointer
GetMaskImage(LabelImageType::Pointer labelImage, LabelPixelType selectedLabelValue)
{
    MaskImageType::Pointer maskImage = MaskImageType::New();
    maskImage->SetRegions(labelImage->GetRequestedRegion());
    maskImage->CopyInformation(labelImage);
...
MaskImageType::RegionType
RoiIndexToRegion(MaskImageType::IndexType roiStart, MaskImageType::IndexType roiEnd)
{
...
void
RegionToIndex(MaskImageType::RegionType outputReigion, MaskImageType::IndexType &roiStart,
...
void
WriteROI(MaskImageType::RegionType inputRegion, string roiName)
{
    MaskImageType::IndexType roiStart;
    MaskImageType::IndexType roiEnd;
...
MaskImageType::RegionType
GetRoi(MaskImageType::Pointer maskImage)
{
    MaskImageType::RegionType roiRegion;
    MaskImageType::IndexType roiStart;
    MaskImageType::IndexType roiEnd;
...
void
ExpandRoi(MaskImageType::Pointer maskImage, MaskImageType::RegionType &maskRegion, const double objectSize)
{
...
void
BoundingCheck(MaskImageType::Pointer maskImage, InputImageType::Pointer inputImage,
  MaskImageType::RegionType &maskRegion, InputImageType::RegionType &inputRegion)
{
...
void
BoundingCheck(MaskImageType::Pointer maskImage, LabelImageType::Pointer inputImage,
  MaskImageType::RegionType &maskRegion, InputImageType::RegionType &inputRegion)
{
    RegionType inputImageRegion = inputImage->GetLargestPossibleRegion();
    SizeType inputImageSize     = inputImageRegion.GetSize();
...
MaskImageType::Pointer
unionImages(vector<MaskImageType::Pointer> inputMaskImages)
{
