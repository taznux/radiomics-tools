...
int main( int argc, char *argv[] )
{
    if ( argc < 3)
    {
        ...
        cerr << "Usage = " << argv[0];
        cerr << " OutputImage OutputText InputLabelImage1 InputLabelImage2 InputLabelImage3" << endl;
        return EXIT_FAILURE;
    }
    ...
    {
        inputLabelImageNames.push_back(argv[i + 3]);
    ...
    for (int i = 0; i < numInputs; i++)
    {
        ...
        maskImage = GetMaskImage(ReadImageFile<LabelImageType>(inputLabelImageNames[i]), 307);
    ...
    for (int i = 0; i < numInputs; i++)
    {
        ...
        string name = inputLabelImageNames[i].substr(10,inputLabelImageNames[i].length()-21); // pre 10 and post 11
