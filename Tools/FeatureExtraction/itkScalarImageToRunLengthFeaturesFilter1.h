 ...
 *
 *=========================================================================*/
#ifndef itkScalarImageToRunLengthFeaturesFilter1_h
#define itkScalarImageToRunLengthFeaturesFilter1_h
...
{
/** \class ScalarImageToRunLengthFeaturesFilter1
 ...
 *
 * \sa ScalarImageToRunLengthFeaturesFilter1
...
class ScalarImageToRunLengthFeaturesFilter1:public ProcessObject
{
public:
  /** Standard typedefs */
  typedef ScalarImageToRunLengthFeaturesFilter1  Self;
  typedef ProcessObject                         Superclass;
  typedef SmartPointer< Self >                  Pointer;
  typedef SmartPointer< const Self >            ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ScalarImageToRunLengthFeaturesFilter1, ProcessObject);
...
#include "itkScalarImageToRunLengthFeaturesFilter1.hxx"
#endif
