...
# paths for tools
dicom2nrrd_converter = os.path.abspath('bin/DICOM-RT2NRRDConverter')
nodule_segmentation = os.path.abspath('bin/NoduleSegmentation')
feature_extraction = os.path.abspath('bin/FeatureExtraction')
